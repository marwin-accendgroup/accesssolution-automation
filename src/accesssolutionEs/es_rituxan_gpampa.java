...
public class es_rituxan_gpampa {
	...
	public static void main(String[] args, WebDriver driver) throws InterruptedException {
		...
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-0.0");
		...
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-1.0");
	
		driver.findElement(By.xpath("//*[@id='accordion']/div/div[1]")).click();
		movecursor(driver);
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-1.0-tab1");
		
		driver.findElement(By.xpath("//*[@id='accordion_0']/div/div[1]")).click();
		movecursor(driver);
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-1.0-tab2");
		...
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-1.0-GATCF-1");
		...
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-1.0-GATCF-2");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.className("start-over")).click();
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.linkText("¿Cómo me inscribo?")).click();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa", "accesssolutions-patient-rituxan-gpampa-1.0-step1");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.linkText("¿Qué averiguaremos?")).click();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa", "accesssolutions-patient-rituxan-gpampa-1.0-step2");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.linkText("¿Qué Opciones Hay?")).click();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa", "accesssolutions-patient-rituxan-gpampa-1.0-step3");
		...
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-2.0");
		
		driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div[2]/div/div/div[2]/div/div[1]/div[2]/div/div[1]/a")).click();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-2.0-esubmit");
		
		driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div[1]/a")).click();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-2.0-more-info-1");
		
		driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div[2]/div/div/div[2]/div/div[3]/div[1]/a")).click();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-2.0-more-info-2");
		...
		driver.findElement(By.xpath("//*[@id='accordion_0']/div/div[1]")).click();
		movecursor(driver);
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-3.0-tab2");
		
		driver.findElement(By.xpath("//*[@id='accordion_1563696486']/div/div[1]")).click();
		movecursor(driver);
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-3.0-tab3");
		...
		movecursor(driver);
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-3.0-tab6");
		
		driver.findElement(By.xpath("//*[@id='accordion_3']/div[1]/div[1]")).click();
		movecursor(driver);
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-3.0-tab7");
		...
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-part1");
		jse.executeScript("window.scrollTo(0, 0)");
		...
		Thread.sleep(1000);
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-part2");
		jse.executeScript("window.scrollTo(0, 0)");
		
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[1]/div[2]/fieldset/button[2]")).click();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-1-part1");
		
		jse.executeScript("window.scrollTo(0, 0)");
		actions.moveToElement(driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[4]/div/p[6]"))).build().perform();
		Thread.sleep(1000);
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-1-part2");
		...
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-more-info-1");
		
		jse.executeScript("window.scrollTo(0, 0)");
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[2]/div[2]/fieldset/button[2]")).click();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-2-part1");
		
		jse.executeScript("window.scrollTo(0, 0)");
		actions.moveToElement(driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[3]/div/p[6]"))).build().perform();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-2-part2");
		Thread.sleep(500);
		...
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-more-info-2");
		
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[3]/div[2]/fieldset/button[2]")).click();
		driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[1]/ul/li[4]/div[2]/fieldset/button[1]")).click();
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-3-part1");
		
		jse.executeScript("window.scrollTo(0, 0)");
		actions.moveToElement(driver.findElement(By.xpath("//*[@id='accesssolutionsembed']/div/div/div/div[2]/div[2]/div/p[6]"))).build().perform();
		Thread.sleep(1000);
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-pat-3-part2");
		
		driver.get("http://localhost:4503/content/accesssolutions-site/es/patient/brands/rituxan/rituxan-gpampa/search.html");
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-patient-rituxan-gpampa-search");
		
		driver.get("http://localhost:4503/content/accesssolutions-site/es/patient/brands/rituxan/rituxan-gpampa/site-map.html");
		fullscreen.desktopScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-patient-rituxan-gpampa-sitemap");
	...
	public static void rituxan_gpampa_mobile(WebDriver driver) throws InterruptedException{
		...
		// ---->> rituxan_gpampa <<---- // 38 screenshots
		driver.get("http://localhost:4503/content/accesssolutions-site/es/patient/brands/rituxan/rituxan-gpampa.html");
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-0.0");
		
		driver.get("http://localhost:4503/content/accesssolutions-site/es/patient/brands/rituxan/rituxan-gpampa/how-we-help-you.html");
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-1.0");
		
		driver.findElement(By.xpath("//*[@id='accordion']/div/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-1.0-tab1");
		
		driver.findElement(By.xpath("//*[@id='accordion_0']/div/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-1.0-tab2");
...
//		jse.executeScript("arguments[0].setAttribute('style', 'padding-bottom:0px;')",element);
		...
		driver.findElement(By.xpath("//*[@id='accordion']/div/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab1");
		
		driver.findElement(By.xpath("//*[@id='accordion_0']/div/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab2");
		
		driver.findElement(By.xpath("//*[@id='accordion_1563696486']/div/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab3");
		
		driver.findElement(By.xpath("//*[@id='accordion_2']/div[1]/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab4");
		
		driver.findElement(By.xpath("//*[@id='accordion_2']/div[2]/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab5");
		
		driver.findElement(By.xpath("//*[@id='accordion_2']/div[3]/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab6");
		
		driver.findElement(By.xpath("//*[@id='accordion_3']/div[1]/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab7");
		
		driver.findElement(By.xpath("//*[@id='accordion_3']/div[2]/div[1]")).click();
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab8");
		
		driver.findElement(By.xpath("//*[@id='accordion_3']/div[3]/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab9");
		
		driver.findElement(By.xpath("//*[@id='accordion_4']/div[1]/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab10");
		
		driver.findElement(By.xpath("//*[@id='accordion_4']/div[2]/div[1]")).click();
		movecursorm(driver);
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-3.0-tab11");
		
		driver.get("http://localhost:4503/content/accesssolutions-site/es/patient/brands/rituxan/rituxan-gpampa/patient-assistance-tool-page.html");
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",  "accesssolutions-mobile-patient-rituxan-gpampa-pat");
		jse.executeScript("window.scrollTo(0, 0)");
		...
		driver.get("http://localhost:4503/content/accesssolutions-site/es/patient/brands/rituxan/rituxan-gpampa/site-map.html");
		fullscreen.mobileScreenshots(driver, "es", "rituxan_gpampa",   "accesssolutions-mobile-patient-rituxan-gpampa-sitemap");
	}
